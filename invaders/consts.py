...
PUP_HIEGHT = 50
# the number of pixels to move the powerup per update
PUP_SPEED = -10
# the number of ALIEN STEPS (not frames) between powerups
PUP_RATE = 30
...
STATE_COMPLETE = 5
# state when the next level of aliens is beginning after first wave is complete
STATE_LEVEL = 6
# state where the instructions of the game are displayed
STATE_INSTRUCTIONS = 7
